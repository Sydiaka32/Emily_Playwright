...
def test_creation_draft(navigate_to_my_auctions, allure_step_with_screenshot, allure_step):
    ...
    allure_step_with_screenshot("Fill in Basic info block", auction_page.fill_basic_info_block)
    allure_step_with_screenshot("Fill in Details block", auction_page.fill_detail_lot_description_block)
    allure_step_with_screenshot("Select classifier", auction_page.select_classifier)
    allure_step("Fill in Lot info block", auction_page.fill_lot_info_block, take_screenshot=False)
    allure_step_with_screenshot("Point map", auction_page.point_map)
